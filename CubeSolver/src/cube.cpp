...
Cube Cube::turn(Cube cube, MoveInstruction mi)
{
	cube.cycle(mi);
	cube.orientEdges(mi);
	//cube.orientCorners(mi);
	return cube;
}

void Cube::cycle(MoveInstruction mi)
{
	switch (mi) {
		case MoveInstruction::FRONT:
			turn(FRONT_EDGES, FRONT_CORNERS);
			break;
		case MoveInstruction::RIGHT:
			turn(RIGHT_EDGES, RIGHT_CORNERS);
			break;
		case MoveInstruction::BACK:
			turn(BACK_EDGES, BACK_CORNERS);
			break;
		case MoveInstruction::LEFT:
			turn(LEFT_EDGES, LEFT_CORNERS);
			break;
		case MoveInstruction::UP:
			turn(UP_EDGES, UP_CORNERS);
			break;
		case MoveInstruction::DOWN:
			turn(DOWN_EDGES, DOWN_CORNERS);
			break;

		case MoveInstruction::FRONT_INVERTED:
			turnI(FRONT_EDGES, FRONT_CORNERS);
			break;
		case MoveInstruction::RIGHT_INVERTED:
			turnI(RIGHT_EDGES, RIGHT_CORNERS);
			break;
		case MoveInstruction::BACK_INVERTED:
			turnI(BACK_EDGES, BACK_CORNERS);
			break;
		case MoveInstruction::LEFT_INVERTED:
			turnI(LEFT_EDGES, LEFT_CORNERS);
			break;
		case MoveInstruction::UP_INVERTED:
			turnI(UP_EDGES, UP_CORNERS);
			break;
		case MoveInstruction::DOWN_INVERTED:
			turnI(DOWN_EDGES, DOWN_CORNERS);
			break;

		case MoveInstruction::FRONT_2:
			turn2(FRONT_EDGES, FRONT_CORNERS);
			break;
		case MoveInstruction::RIGHT_2:
			turn2(RIGHT_EDGES, RIGHT_CORNERS);
			break;
		case MoveInstruction::BACK_2:
			turn2(BACK_EDGES, BACK_CORNERS);
			break;
		case MoveInstruction::LEFT_2:
			turn2(LEFT_EDGES, LEFT_CORNERS);
			break;
		case MoveInstruction::UP_2:
			turn2(UP_EDGES, UP_CORNERS);
			break;
		case MoveInstruction::DOWN_2:
			turn2(DOWN_EDGES, DOWN_CORNERS);
			break;
	}
}

void Cube::orientEdges(MoveInstruction mi)
{
	switch (mi) {
		case MoveInstruction::FRONT:
		case MoveInstruction::BACK:
