...
public class Main {
	...
	public static void main(String args[]) {
		...
		CubeParser parser = new CubeParser("res/Cube2/front.png", "res/Cube2/back.png", "res/Cube2/left.png", "res/Cube2/right.png",
				"res/Cube2/up.png", "res/Cube2/down.png");

		Cube myCube = parser.getCube();
		solve(myCube);
		// printCube(myCube);
	}
	...
	public static boolean solved1(Cube cube) {
		return cube.up[0][1] == Cube.WHITE && cube.up[1][0] == Cube.WHITE && cube.up[1][2] == Cube.WHITE
				&& cube.up[2][1] == Cube.WHITE;
	}
	...
	public static void step2(Cube cube) {
		while (!solved2(cube)) {
			if (cube.data[Cube.FRONT][0][1] == cube.data[Cube.FRONT][1][1] && cube.data[Cube.UP][2][1] == Cube.WHITE) {
				cube.turnFront(2, 0);
	...
	public static boolean solved2(Cube cube) {
		return cube.down[0][1] == Cube.WHITE && cube.down[1][0] == Cube.WHITE && cube.down[1][2] == Cube.WHITE
		...
		while (!solved3(cube)) {
			...
			for (int face = 0; face < Cube.UP; face++) {
				if (cube.data[face][0][0] == Cube.WHITE) {
					...
					while (!(cube.isAdjacent(face, 0, 0, leftFace(face)) && cube.isAdjacent(face, 0, 0, face))) {
						cube.turnUp(1);
						face = leftFace(face);
					}
					for (int i = 0; i < 5; i++) {
			...
			for (int face = 0; face < Cube.UP; face++) {
				if (cube.data[face][0][2] == Cube.WHITE) {
					...
					while (!(cube.isAdjacent(face, 0, 2, rightFace(face)) && cube.isAdjacent(face, 0, 2, face))) {
						cube.turnUp(3);
						face = rightFace(face);
					}
					face = rightFace(face);
		...
		while (!solved4(cube)) {
			...
			for (int face = 0; face < Cube.UP; face++) {
				if ((cube.data[face][1][0] != Cube.YELLOW && cube.data[face][1][0] != face)
						&& (cube.data[leftFace(face)][1][2] != Cube.YELLOW
								&& cube.data[leftFace(face)][1][2] != leftFace(face))) {
					leftEdgeFix(cube, face);
				}
			}
		}
	...
	public static boolean solved5(Cube cube) {
		...
		return cube.up[0][1] == Cube.YELLOW && cube.up[1][0] == Cube.YELLOW && cube.up[2][1] == Cube.YELLOW
	...
	public static void step6(Cube cube) {
		...
		while (!solved6(cube)) {
			if (cube.up[2][0] == Cube.YELLOW && cube.up[2][2] != Cube.YELLOW && cube.up[0][2] != Cube.YELLOW
					&& cube.up[0][0] != Cube.YELLOW) {
				doTheFun(cube, Cube.FRONT);
			} else if (cube.up[2][2] == Cube.YELLOW && cube.up[2][0] != Cube.YELLOW && cube.up[0][2] != Cube.YELLOW
					&& cube.up[0][0] != Cube.YELLOW) {
				doTheFun(cube, Cube.RIGHT);
			} else if (cube.up[0][2] == Cube.YELLOW && cube.up[2][0] != Cube.YELLOW && cube.up[2][2] != Cube.YELLOW
					&& cube.up[0][0] != Cube.YELLOW) {
				doTheFun(cube, Cube.BACK);
			} else if (cube.up[0][0] == Cube.YELLOW && cube.up[2][0] != Cube.YELLOW && cube.up[2][2] != Cube.YELLOW
	...
	public static boolean solved6(Cube cube) {
		...
		return cube.up[0][0] == Cube.YELLOW && cube.up[0][2] == Cube.YELLOW && cube.up[2][0] == Cube.YELLOW
	...
	public static boolean solved8(Cube cube) {
		...
		for (int turns = 0; turns < 4; turns++) {
			...
			if (cube.front[0][1] == Cube.GREEN && cube.front[0][0] == Cube.GREEN && cube.right[0][1] == Cube.ORANGE) {
				return true;
			}
		}
		return false;
